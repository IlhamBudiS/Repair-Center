...
<html>
	...
	<!-- Animate.css -->
	<link rel="stylesheet" href="{{ url('assets_dashboard/css/animate.css') }}">
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="{{ url('assets_dashboard/css/icomoon.css') }}">
	<!-- Bootstrap  -->
	<link rel="stylesheet" href="{{ url('assets_dashboard/css/bootstrap.css') }}">

	<!-- Flexslider  -->
	<link rel="stylesheet" href="{{ url('assets_dashboard/css/flexslider.css') }}">

	<!-- Owl Carousel  -->
	<link rel="stylesheet" href="{{ url('assets_dashboard/css/owl.carousel.min.css') }}">
	<link rel="stylesheet" href="{{ url('assets_dashboard/css/owl.theme.default.min.css') }}">

	<!-- Theme style  -->
	<link rel="stylesheet" href="{{ url('assets_dashboard/css/style.css') }}">

	<!-- Modernizr JS -->
	<script src="{{ url('assets_dashboard/js/modernizr-2.6.2.min.js')}}"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>-->
	<script src="{{ url('assets_dashboard/js/respond.min.js')}}"></script>
	<![endif]-->
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-xs-2">
					<div id="fh5co-logo">
						<img src="{{ url('assets_dashboard/images/logo.jpg') }}" alt="">
						<a href="index.html">RepairCenter</a>
					</div>
				</div>
	...
	<!-- jQuery -->
	<script src="{{ url('assets_dashboard/js/jquery.min.js') }}"></script>
	<!-- jQuery Easing -->
	<script src="{{ url('assets_dashboard/js/jquery.easing.1.3.js') }}"></script>
	<!-- Bootstrap -->
	<script src= "{{ url('assets_dashboard/js/bootstrap.min.js') }}" ></script>
	<!-- Waypoints -->
	<script src= "{{ url('assets_dashboard/js/jquery.waypoints.min.js') }}" ></script>
	<!-- Carousel -->
	<script src= "{{ url('assets_dashboard/js/owl.carousel.min.js') }}" ></script>
	<!-- countTo -->
	<script src= "{{ url('assets_dashboard/js/jquery.countTo.js') }}" ></script>
	<!-- Flexslider -->
	<script src= "{{ url('assets_dashboard/js/jquery.flexslider-min.js') }}" ></script>
	<!-- Main -->
	<script src= "{{ url('assets_dashboard/js/main.js') }}" ></script>
